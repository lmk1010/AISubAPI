export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      response: '响应：',
      firstResponseLatency: '首包延迟：{time}',
    ...
    upstreamCost: {
      title: '上游成本分析',
      description: '对比上游渠道消耗与内部计费，分析盈亏',
      providerConfig: '上游配置',
      providerType: '上游类型',
      baseUrl: '站点地址',
      baseUrlPlaceholder: '例如：https://fluxnode.org',
      poolKey: '额度池标识',
      poolKeyPlaceholder: '不填则按上游账号自动识别；同站点不同 key 自动分开',
      poolName: '额度池名称',
      poolNamePlaceholder: '例如：foxnio 共享池',
      accessToken: '系统访问令牌',
      accessTokenPlaceholder: '输入系统访问令牌',
      userId: '用户 ID',
      ...
      user: '用户',
      fetchAll: '批量查询',
      noChannels: '暂无渠道，请先在渠道管理中创建',
      viewDetail: '查看详情',
      costDetail: '成本详情',
      configIncomplete: '请填写上游配置以查询成本',
      noConfiguredChannels: '没有已配置的渠道，请先填写至少一个渠道的上游信息',
      modelBreakdown: '模型消耗分布',
      last7d: '近 7 天',
      last30d: '近 30 天',
      thisMonth: '本月',
      lastMonth: '上月',
      last90d: '近 90 天',
      upstreamTotal: '上游总成本',
      paidToUpstream: '支付给上游的费用',
      internalRevenue: '内部收入',
      chargedToUsers: '向用户收取的费用',
      profitLoss: '盈亏',
      profitable: '盈利',
      losing: '亏损',
      margin: '利润率',
      ...
      upstreamCostRMB: '上游成本(¥)',
      revenueRMB: '下游计费(¥)',
      actualPaymentRMB: '实际付费(¥)',
      profitRMB: '盈亏(¥)',
      exchangeRate: '金额口径',
      dailyTrend: '每日趋势',
      channelName: '渠道',
      upstreamPool: '上游额度池',
      sharedPool: '共享 {count} 个账号',
      singlePool: '单账号池',
      accountMultiplier: '账号倍率',
      configure: '配置',
      saveConfig: '保存配置',
      configSaved: '上游配置已保存',
      missingRemoteCredentials: '缺少上游登录凭据，只能查看本地日志汇总',
      balance: '请求数',
    },
    ...
    settings: {
      ...
      adminRateLimit: {
        title: '管理 API 速率限制',
        description: '限制每个 IP 的请求频率，防止管理接口被暴力攻击',
        enabled: '启用速率限制',
        maxRequests: '最大请求数',
        maxRequestsHint: '每个时间窗口内每个 IP 允许的最大请求数（1-10000）',
        windowSeconds: '时间窗口（秒）',
        windowSecondsHint: '速率限制时间窗口的持续时间（1-3600 秒）',
        saved: '管理 API 速率限制设置已保存',
        loadError: '加载管理 API 速率限制设置失败',
        saveError: '保存管理 API 速率限制设置失败'
      },
      soraS3: {
        title: 'Sora 存储配置',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 吉米耐',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">吉米耐 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 吉米耐',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 吉米耐 AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
