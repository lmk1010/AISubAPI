export default {
  ...
  // Setup Wizard
  setup: {
    title: 'JimiNaishop Setup',
    description: 'Configure your JimiNaishop instance',
    database: {
  ...
  admin: {
    ...
    accounts: {
      ...
      response: 'Response:',
      firstResponseLatency: 'First response latency: {time}',
      ...
      imagePromptDefault: 'tiny orange cat sticker',
    ...
    // Upstream Cost Analysis
    upstreamCost: {
      title: 'Upstream Cost Analysis',
      description: 'Compare upstream channel consumption with internal billing to analyze profit/loss',
      providerConfig: 'Provider Config',
      providerType: 'Provider Type',
      baseUrl: 'Base URL',
      baseUrlPlaceholder: 'e.g. https://fluxnode.org',
      poolKey: 'Quota Pool Key',
      poolKeyPlaceholder: 'Blank = auto-detect upstream identity; same site with different keys is split',
      poolName: 'Quota Pool Name',
      poolNamePlaceholder: 'e.g. foxnio shared pool',
      accessToken: 'System Access Token',
      accessTokenPlaceholder: 'Enter system access token',
      userId: 'User ID',
      ...
      user: 'User',
      fetchAll: 'Fetch All',
      noChannels: 'No channels yet. Create one in Channel Management first.',
      viewDetail: 'View Detail',
      costDetail: 'Cost Detail',
      configIncomplete: 'Fill in upstream config to query costs',
      noConfiguredChannels: 'No configured channels. Please fill in upstream info for at least one channel.',
      modelBreakdown: 'Model Cost Breakdown',
      last7d: 'Last 7 Days',
      ...
      paidToUpstream: 'Paid to upstream providers',
      internalRevenue: 'Internal Revenue',
      chargedToUsers: 'Charged to users',
      profitLoss: 'Profit / Loss',
      profitable: 'Profitable',
      losing: 'Losing',
      margin: 'Margin',
      marginDesc: '(Revenue - Cost) / Cost',
      upstreamCostLabel: 'Upstream Cost ($)',
      internalRevenueLabel: 'Internal Revenue ($)',
      upstreamCostRMB: 'Upstream Cost (¥)',
      revenueRMB: 'Downstream Billing (¥)',
      actualPaymentRMB: 'Paid (¥)',
      profitRMB: 'P/L (¥)',
      exchangeRate: 'Amount Basis',
      dailyTrend: 'Daily Trend',
      channelName: 'Channel',
      upstreamPool: 'Upstream Pool',
      sharedPool: 'Shared by {count} accounts',
      singlePool: 'Single account pool',
      accountMultiplier: 'Account multiplier',
      configure: 'Configure',
      saveConfig: 'Save Config',
      configSaved: 'Upstream config saved',
      missingRemoteCredentials: 'Missing upstream credentials. Local log summary only.',
      balance: 'Requests',
    },
    ...
    settings: {
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'JimiNaishop',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'JimiNaishop',
        useTls: 'Use TLS',
      ...
      adminRateLimit: {
        ...
        description: 'Limit the number of requests per IP to protect admin endpoints from brute-force attacks',
        enabled: 'Enable Rate Limiting',
        maxRequests: 'Max Requests',
        maxRequestsHint: 'Maximum requests per time window per IP (1-10000)',
        windowSeconds: 'Time Window (seconds)',
        windowSecondsHint: 'Duration of the rate-limit window in seconds (1-3600)',
        saved: 'Admin rate limit settings saved',
        loadError: 'Failed to load admin rate limit settings',
        saveError: 'Failed to save admin rate limit settings'
      },
      soraS3: {
        title: 'Sora Storage',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to JimiNaishop',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">JimiNaishop is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of JimiNaishop, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to JimiNaishop',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the JimiNaishop AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
